...
public class AppContext {
    ...
    private void registrarRepositorios() {
        ...
        registrar(CategoriaRepository.class, categoriaRepository);

        MarcaRepository marcaRepository = new MarcaRepository();
        marcaRepository.seedData();
        registrar(MarcaRepository.class, marcaRepository);

        UnidadMedidaRepository unidadMedidaRepository = new UnidadMedidaRepository();
        unidadMedidaRepository.seedData();
        registrar(UnidadMedidaRepository.class, unidadMedidaRepository);
