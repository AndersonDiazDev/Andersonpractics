...
public class UnidadMedidaServiceImp
        extends CrudGenericoServiceImp<UnidMedida, Long>
        implements IUnidadMedidaService {

    private final UnidadMedidaRepository unidadMedidaRepository;

    public UnidadMedidaServiceImp(
    ...
    public List<ComboBoxOption> listarCombobox() {
        ...
        for (UnidMedida unidad : unidadMedidaRepository.findAll()) {

            ComboBoxOption cb = new ComboBoxOption();

            cb.setKey(
                    String.valueOf(unidad.getIdUnidad())
            );

            cb.setValue(
                    unidad.getNombreMedida()
            );
